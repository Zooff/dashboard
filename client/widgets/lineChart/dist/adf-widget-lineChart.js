...
function lineChartService($q, $http, $parse){
  ...
  function createData(jsonData, config){
    ...
    label = jsonData.map(function(u){console.log(config.xAxeFormat) ;return config.xAxeType ? moment(getLabel(u), config.xAxeFormat) : getLabel(u);});
