...
function checkStandardWidget(dashboardProvider){
  dashboardProvider
    .widget('checkStandard', {
      title: 'Check Perso',
      description: 'Widgets permettant la création de Check personalisé',
